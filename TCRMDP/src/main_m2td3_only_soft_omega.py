...
from m2td3.trainer_only_soft_omega import Trainer  # NOTE: OnlySoftOmega trainer
from m2td3.algo_only_soft_omega import M2TD3Config
...
def main(
    ...
    **kwargs: Unpack[M2TD3Config],
    ...
    """Train an agent using the M2TD3 worst-actor + soft-omega algorithm.

    This function sets up and trains a reinforcement learning agent using the variant
    where the actor is updated with the worst-case omega and omega is updated softly.
    ...
    Args:
        ...
        omega_temperature_start (float, optional): Start temperature parameter for soft omega update. Defaults to 1000.0.
        omega_temperature_end (float, optional): End temperature parameter for soft omega update. Defaults to 4.0.
