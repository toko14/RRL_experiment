...
def main(
    env_name: str = "Walker",
    project_name: str = "dev_vanilla_tc_rarl_001",
    ...
    **kwargs,
    ...
    """Train an agent using the vanilla Time-Constrained RARL algorithm.

    This function trains a reinforcement learning agent using the vanilla declination of
    the Time-Constrained (TC) algorithm integrated with the Robust Adversarial Reinforcement
    Learning (RARL) framework. The environment includes time constraints and supports
    adversarial setups with customizable uncertainty dimensions and radius bounds.

    Args:
        env_name (str, optional): Name of the environment to train in. Defaults to "Walker".
        project_name (str, optional): Name of the project for logging and tracking. Defaults to "dev_vanilla_tc_rarl_001".
        ...
        radius (float, optional): Radius for uncertainty bounds in the TC environment. Defaults to 0.001.
        ...
        **kwargs: Additional configuration parameters for `TrainerAdversarial`.
    """
