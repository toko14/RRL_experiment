...
def main(
    env_name: str = "Walker",
    project_name: str = "dev_stacked_tc_rarl_001",
    ...
    **kwargs,
    ...
    """Train an agent using Stacked Time-Constrained RARL.

    This function sets up and trains an agent using the Robust Adversarial Reinforcement Learning (RARL)
    algorithm within a Stacked Time-Constrained MDP (StackedTCMDP) environment. The environment
    supports uncertainty modeling, adversarial behavior, and stacked time constraints.

    Args:
        env_name (str, optional): Name of the environment to train in. Defaults to "Walker".
        project_name (str, optional): Name of the project for logging and tracking. Defaults to "dev_stacked_tc_rarl_001".
        nb_uncertainty_dim (int, optional): Number of uncertainty dimensions in the environment. Defaults to 3.
        ...
        eval_freq (int, optional): Frequency (in steps) for evaluating the agent. Defaults to 10,000.
        track (bool, optional): Whether to enable tracking of training progress. Defaults to True.
        radius (float, optional): Radius for the uncertainty bound in the StackedTCMDP. Defaults to 0.001.
        omniscient_adversary (bool, optional): If True, the adversary has omniscient knowledge of the agent's actions. Defaults to True.
        device (str, optional): Device to use for training computations (e.g., "cuda:0" or "cpu"). Defaults to "cuda:0".
        output_dir (str, optional): Directory for saving results, logs, and models. Defaults to "results".
